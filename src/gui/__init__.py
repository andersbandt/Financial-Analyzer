...
# import tab classes
from gui.tabs import (analyze_history, budgetting, categorize_transactions,
                      dashboard, edit_category, load_data, review_balances,
                      review_investments)
...
class MainApplication:
    def __init__(self, window, *args, **kwargs):
        ...
        self.basefilepath = (
            "C:/Users/ander/OneDrive/Documents/Financials/2021/Monthly Statements/"
        )
