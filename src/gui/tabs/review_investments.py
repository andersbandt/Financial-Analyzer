...
from analysis import graphing_analyzer, inv_h
...
class tabInvestments:
    ...
    def init_fr_add_inv_data(self):
        ...
        drop = tk.OptionMenu(
            self.fr_add_inv_data, clicked_account, *acc_names
        ...
        add_keyword = tk.Button(
            self.fr_add_inv_data,
            text="Add Investment Ticker Data",
            command=lambda: self.add_investment_data(
                date_entry.get(),
                clicked_account.get(),
                investment_ticker,
                transaction_amount,
    ...
    def init_fr_rev_inv_data(self):
        ...
        start_analyzing = tk.Button(
            self.fr_rev_inv_data,
            text="Print Current Position Data",
            command=lambda: self.review_inv_acc(),
        )
    ...
    def init_fr_gr_inv(self):
        ...
        b_asset_alloc = tk.Button(
            fr_title_button,
            text="Show Asset Allocation",
            command=lambda: self.show_asset_alloc(),
        )
        ...
        b_hist_price = tk.Button(
            fr_title_button,
            text="Show Historical Price",
            command=lambda: self.show_hist_price_data(),
        )
    ...
    def add_investment_data(
        self, date, account_id, ticker_obj, amount_obj, inv_type_obj
    ):
    ...
    def show_asset_alloc(self):
        ...
        try:
            ...
            gui_helper.alert_user(
                ...
                "Connection error. Please check connection and try again.",
                kind="error",
            )
