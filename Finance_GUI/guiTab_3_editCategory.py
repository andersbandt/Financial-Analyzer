...
class tabEditCategory:
    def __init__(self, master, conn):
        ...
        self.prompt = Text(self.frame, padx=5, pady=5, height=6, width=25)
    ...
    def initTabContent(self):
        ...
        category_name = Text(self.frame, height=3, width=20)
        ...
        account_name = Text(self.frame, height=3, width=20)
        ...
        keyword_name = Text(self.frame, height=3, width=20)
    ...
    def add_category_gui(self, category_name_obj, parent_status, parent):
        ...
        if database_helper.insert_category(parent, category_name):
    ...
    def add_account_gui(self, account_name):
        with self.conn:
