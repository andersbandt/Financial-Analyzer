...
import BrandImage from '/src/components/BrandImage.vue';
import CollapseButton from '/src/components/CollapseButton.vue';
import MenuOptions from '/src/components/MenuOptions.vue';
