...
<CCard class="text-center" style="width: 100%; height: 100%">
  <CCardHeader>
    ...
    <section class="main-content-section">
      ...
      <div class="container pt-3 pb-4">
        <div class="row justify-content-center mb-4">
          <div class="col-lg-6">
            <span class="badge badge-primary mb-1">A highly customizable personal finance manager</span>
            <div class="code-text">
              view project on
              <a href="https://github.com/andersbandt/Financial-Analyzer" target="_blank" >
                GitHub
              </a>
            </div>
          </div>
            ...
            subMenuOptions: [
              {
                ...
                type: 'link',
                text: 'Review',
                subText: 'Review previously loaded in transactions',
                path: {name: 'about'},
              },
              {
                type: 'hr',
              },
              {
                type: 'link',
                text: 'Analyze',
                subText: "Analyze spending trends",
                path: {name: 'locations'},
              },
            ],
          },
            ...
            subMenuOptions: [
              {
                ...
                type: 'link',
                text: 'Local file',
                subText: 'Load in from local .csv file',
                path: {name: 'about'},
              },
              {
                type: 'hr',
