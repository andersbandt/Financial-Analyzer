...
class VanguardBrokerage(Statement.Statement):
    ...
    def load_statement_data(self):
        transactions = []
        gui_helper.gui_print(self.frame, self.prompt, "Extracting raw Vanguard Brokerage statement at: ", self.filepath)
        ...
        try:
            with open(self.filepath, 'rb') as f:
                ...
                start_balance = balances_string[whitespace_index[2] + 2:whitespace_index[3]].replace(',', '')
